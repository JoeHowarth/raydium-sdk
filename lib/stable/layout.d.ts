...
declare const STABLE_STATE_LAYOUT_V1: Structure<_solana_web3_js.PublicKey | bn_js | bn_js[], "", {
...
declare type StableStateLayoutV1 = typeof STABLE_STATE_LAYOUT_V1;
declare type StableStateLayout = StableStateLayoutV1;
declare type StableStateV1 = GetStructureSchema<StableStateLayoutV1>;
declare type StableState = StableStateV1;
declare const STABLE_VERSION_TO_STATE_LAYOUT: {
    [version: number]: StableStateLayout;
};

export { STABLE_STATE_LAYOUT_V1, STABLE_VERSION_TO_STATE_LAYOUT, StableState, StableStateLayout, StableStateLayoutV1, StableStateV1 };
